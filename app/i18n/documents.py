...
_EN = {
 ...
 "documents.send_file":"📎 Send a photo, an image as a file, or a PDF.", "documents.file_added":"✅ File added.", "documents.add_file":"➕ Add another file", "documents.cancel":"❌ Cancel", "documents.done":"✅ Done", "documents.delete_draft":"❌ Delete document",
 "documents.created":"✅ Document created", "documents.added_success":"✅ Document added", "documents.files":"Files: {count}", "documents.category":"Category", "documents.owner_label":"Owner", "documents.access_label":"Access", "documents.added":"Added",
