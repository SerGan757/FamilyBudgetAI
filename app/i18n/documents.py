...
_EN = {
 ...
 "documents.search_prompt":"Enter part of the document title.", "documents.search_empty":"No documents found.", "documents.not_found":"Document or category not found.", "documents.deleted":"Document deleted.",
}
